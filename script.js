...
$(function(){
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="topping" class="form-control" id="topping">
                                        <option value=""></option>
                                        <option value="veggies">bell peppers</option>
                                        <option value="grain">sweetcorn</option>
                                        <option value="mushrooms">oregano</option>
                                        <option value="cheese">extra parmessan/Mozarella</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col">
    ...
    $('#delivery').change(function(){
        if($(this).is(':checked') && $(this).val() =="delivery"){
            ...
            $('.total').html(`<h2>Total : ${calculateCheckOutPrice() + 100} (Inclusive of kshs 100 delivery fee)</h2>`);            
        }
    })
    ...
    $(".checkout-btn").click(function(){
        ...
        $('#alert').append(`
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Tumepata agizo lako!</strong><span id="checkout-alert">Subiri agizo lako angalau saa moja. karibu tena!</span>
